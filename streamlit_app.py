...
st.markdown("""
<a href='https://www.youtube.com/dataprofessor' class="btn btn-outline-primary btn-lg btn-block bi bi-youtube" type="button" aria-pressed="true">Data Professor YouTube channel</a>
