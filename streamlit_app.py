...
st.markdown("""
<a href='https://www.youtube.com/dataprofessor' class="btn btn-outline-primary btn-lg btn-block" type="button" aria-pressed="true">&#xF62B Data Professor YouTube channel</a>
